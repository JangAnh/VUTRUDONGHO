      ...
      <div id="content-user">
        ...
        while ($row = mysqli_fetch_array($result4)) {
          ...
          <div class="main-component-order"
            ...
            <p class="styleTextMyOrder" style="width: 13%;">' . number_format($price, 0, ',', '.') . '$</p>
          ...
          <div style="width: 100%;height: fit-content;display: flex;flex-direction: row;margin-bottom: 20px;">
            ...
            <div id="total_detail_order" style="width: 50%;height:fit-content;display: flex;flex-direction: row;">
              ...
              <div id="value_total_detail_order"
                ...
                <p class="styleTextMyOrder"><?php echo number_format($tongtien1mathang, 0, ',', '.');?> $</p>
                <p class="styleTextMyOrder">+ <?php echo number_format($shippingFee, 0, ',', '.');?> $</p>
                <p class="styleTextMyOrder" style="color: red;">- <?php echo $orderDiscount_formatted;?> $</p>
                <hr style="width:100%">
                <p class="styleTextMyOrder"><?php echo $orderTotal_formatted;?> $</p>
              </div>
            </div>
          </div>
        </div>
