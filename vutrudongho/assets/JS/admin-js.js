...
var callApiDistrict = (api) => {
  return axios.get(api).then((response) => {
    renderData(
      ...
      "modal-user-container-content-district"
    );
  });
};
var callApiWard = (api) => {
...
var eventForAddressCombobox = () => {
  $("#modal-user-container-content-province").on("input", function () {
    if (
      $("#modal-user-container-content-province option:selected").val() != ""
    ) {
      callApiDistrict(
        host +
          "p/" +
          $("#modal-user-container-content-province").val().split("/")[0] +
          "?depth=2"
      );
    } else {
      document.querySelector(
        "#modal-user-container-content-district"
      ).innerHTML = '<option disable value="">-- Chọn --</option>';
      document.querySelector("#modal-user-container-content-ward").innerHTML =
  ...
  $("#modal-user-container-content-district").on("input", function () {
    if (
      $("#modal-user-container-content-district option:selected").val() != ""
    ) {
      callApiWard(
        host +
          "d/" +
          $("#modal-user-container-content-district").val().split("/")[0] +
          "?depth=2"
      );
    } else {
      document.querySelector("#modal-user-container-content-ward").innerHTML =
...
var displayEditModal = (productId) => {
  //Display
  var modal_heading = document.querySelector(
  ...
  let id = document.getElementById(
    "modal-product-container-content__product-id"
  );
  let name = document.getElementById(
    "modal-product-container-content__product-name"
  );
  let img = document.getElementById(
    "modal-product-container-content__product-img"
  );
  let img_src = document.getElementById(
    "modal-product-container-content__product-img-src"
  );
  ...
  let gender = document.getElementById(
    "modal-product-container-content__gender"
  );
  let import_price = document.getElementById(
    "modal-product-container-content__import-price"
  );
  let price_to_sell = document.getElementById(
    "modal-product-container-content__price-to-sell"
  );
  let discount = document.getElementById(
    "modal-product-container-content__discount"
  );
...
var resetErr = () => {
  let brand_err = document.querySelector(
    ".modal-product-container-content__err-brand"
  );
  let name_err = document.querySelector(
    ".modal-product-container-content__err-name"
  );
  let img_err = document.querySelector(
    ".modal-product-container-content__err-img"
  );
  let model_err = document.querySelector(
    ".modal-product-container-content__err-model"
  );
  let orther_input_model_err = document.querySelector(
    ".modal-product-container-content__err-other-model"
  );
  let color_err = document.querySelector(
    ".modal-product-container-content__err-color"
  );
  let orther_input_color_err = document.querySelector(
    ".modal-product-container-content__err-other-color"
  );
  let gender_err = document.querySelector(
    ".modal-product-container-content__err-gender"
  );
  let import_price_err = document.querySelector(
    ".modal-product-container-content__err-import-price"
  );
  let price_to_sell_err = document.querySelector(
    ".modal-product-container-content__err-price-to-sell"
  );
  let discount_err = document.querySelector(
    ".modal-product-container-content__err-discount"
  );
  let desc_err = document.querySelector(
...
var checkValidateProductForm = (action) => {
  ...
  let orther_input_model = document.getElementById(
    "orther-product-model-value"
  );
  let orther_input_model_err = document.querySelector(
    ".modal-product-container-content__err-other-model"
  );
  ...
  let orther_input_color = document.getElementById(
    "orther-product-color-value"
  );
  let orther_input_color_err = document.querySelector(
    ".modal-product-container-content__err-other-color"
  );
  ...
  if (
    img.value.trim() == "" &&
    img_src.getAttribute("src") ==
      "./assets/img/admin/place-holder-product/image-placeholder.jpg"
  ) {
  ...
  if (valid) {
    let result = confirm(
      `Bạn có chắc chắn muốn ${action} đồng hồ này trong cơ sở dữ liệu?`
    );
    valid = result;
  }
  return valid;
...
var displayPopupDel = (productId) => {
  var conf = confirm(
    `Bạn có chắc chắn muốn xóa sản phẩm ${productId} ra khỏi cơ sở dữ liệu?`
  );
  if (conf) {
...
var displayInsertBrandModal = (newBrandId) => {
  var modal_heading = document.querySelector(
    ".modal-brand-container-content__heading"
  );
  var modal = document.querySelector(".modal-brand");
  var btnAdd = document.querySelector(
    ".modal-brand-container-content__btn.insert"
  );
  var btnEdit = document.querySelector(
    ".modal-brand-container-content__btn.edit"
  );
...
var displayEditBrandModal = (brandId) => {
  ...
  let brand_name = document.getElementById(
    "modal-brand-container-content-name"
  );
  let brand_desc = document.getElementById(
    "modal-brand-container-content-desc"
  );
  let brand_status_true = document.getElementById(
    "modal-brand-container-content-status-true"
  );
  let brand_status_false = document.getElementById(
    "modal-brand-container-content-status-false"
  );
...
var resetErrBrandForm = () => {
  let brand_name_err = document.querySelector(
    ".modal-brand-container-content-name__err"
  );
  let brand_desc_err = document.querySelector(
    ".modal-brand-container-content-desc__err"
  );
...
var checkBrandForm = (action) => {
  ...
  if (valid) {
    ...
    if (action == "thêm") {
      result = confirm(
        `Bạn có chắc chắn muốn ${action} thương hiệu này vào cơ sở dữ liệu?`
      );
    } else {
      result = confirm(
        `Bạn có chắc chắn muốn ${action} thương hiệu này vào cơ sở dữ liệu? Lưu ý: Nếu thương hiệu này ngừng hoạt động, thì các sản phẩm thuộc thương hiệu cũng sẽ ngừng kinh doanh, bạn có chắc chắn muốn thay đổi?`
      );
    }
    valid = result;
  }
...
var displayInsertSupplierModal = (newSupplierId) => {
  var modal_heading = document.querySelector(
    ".modal-supplier-container-content__heading"
  );
  var modal = document.querySelector(".modal-supplier");
  var btnAdd = document.querySelector(
    ".modal-supplier-container-content__btn.insert"
  );
  var btnEdit = document.querySelector(
    ".modal-supplier-container-content__btn.edit"
  );
...
var resetSupplierForm = (newSupplierId) => {
  let supplier_id = document.getElementById(
    "modal-supplier-container-content-id"
  );
  let supplier_name = document.getElementById(
    "modal-supplier-container-content-name"
  );
  let supplier_phone = document.getElementById(
    "modal-supplier-container-content-phone"
  );
  let supplier_email = document.getElementById(
    "modal-supplier-container-content-email"
  );
  let supplier_address = document.getElementById(
    "modal-supplier-container-content-address"
  );
  let supplier_status_true = document.getElementById(
    "modal-supplier-container-content-status-true"
  );
...
var resetErrSupplierForm = () => {
  let supplier_name_err = document.querySelector(
    ".modal-supplier-container-content-name__err"
  );
  let supplier_phone_err = document.querySelector(
    ".modal-supplier-container-content-phone__err"
  );
  let supplier_email_err = document.querySelector(
    ".modal-supplier-container-content-email__err"
  );
  let supplier_address_err = document.querySelector(
    ".modal-supplier-container-content-address__err"
  );
...
var displayEditSupplierModal = (supplierId) => {
  let modal_heading = document.querySelector(
    ".modal-supplier-container-content__heading"
  );
  ...
  let supplier_status_false = document.getElementById(
    "modal-supplier-container-content-status-false"
  );
...
var checkSupplierForm = (action) => {
  ...
  if (valid) {
    let result = confirm(
      `Bạn có chắc chắn muốn ${action} nhà cung cấp này vào cơ sở dữ liệu?`
    );
    valid = result;
  }
...
var displayInsertVoucherModal = (newVoucherId) => {
  var modal_heading = document.querySelector(
    ".modal-voucher-container-content__heading"
  );
  var modal = document.querySelector(".modal-voucher");
  var btnAdd = document.querySelector(
    ".modal-voucher-container-content__btn.insert"
  );
  var btnEdit = document.querySelector(
    ".modal-voucher-container-content__btn.edit"
  );
...
var resetVoucherForm = (newVoucherId) => {
  let voucher_id = document.getElementById(
    "modal-voucher-container-content-id"
  );
  let voucher_name = document.getElementById(
    "modal-voucher-container-content-name"
  );
  let voucher_unit = document.getElementById(
    "modal-voucher-container-content-unit"
  );
  let voucher_discount = document.getElementById(
    "modal-voucher-container-content-discount"
  );
  let dateFrom = document.getElementById(
    "modal-voucher-container-content-dateFrom"
  );
  let dateTo = document.getElementById(
    "modal-voucher-container-content-dateTo"
  );
  let voucher_status_true = document.getElementById(
    "modal-voucher-container-content-status-true"
  );
...
var resetErrVoucherForm = () => {
  let voucher_name_err = document.querySelector(
    ".modal-voucher-container-content-name__err"
  );
  let voucher_unit_err = document.querySelector(
    ".modal-voucher-container-content-unit__err"
  );
  let voucher_discount_err = document.querySelector(
    ".modal-voucher-container-content-discount__err"
  );
  let voucher_dateFrom_err = document.querySelector(
    ".modal-voucher-container-content-dateFrom__err"
  );
  let voucher_dateTo_err = document.querySelector(
    ".modal-voucher-container-content-dateTo__err"
  );
...
var checkVoucherForm = (action) => {
  ...
  if (dateFrom.value != "" && dateTo.value != "") {
    ...
    if (dateF > dateT) {
      voucher_dateFrom_err.innerText =
        "*Ngày bắt đầu không được lớn hơn ngày kết thúc";
      voucher_dateFrom_err.style.display = "block";
      voucher_dateTo_err.innerText =
  ...
  if (valid) {
    let result = confirm(
      `Bạn có chắc chắn muốn ${action} mã giảm giá này vào cơ sở dữ liệu?`
    );
    valid = result;
  }
...
var displayEditVoucherModal = (voucherId) => {
  ...
  let voucher_status_false = document.getElementById(
    "modal-voucher-container-content-status-false"
  );
...
var displayInsertUserModal = (newUserId) => {
  var modal_heading = document.querySelector(
    ".modal-user-container-content__heading"
  );
  var modal = document.querySelector(".modal-user");
  var btnAdd = document.querySelector(
    ".modal-user-container-content__btn.insert"
  );
  var btnEdit = document.querySelector(
    ".modal-user-container-content__btn.edit"
  );
...
var resetUserform = (newUserId) => {
  ...
  let user_phone = document.getElementById(
    "modal-user-container-content-phone"
  );
  let user_email = document.getElementById(
    "modal-user-container-content-email"
  );
  let user_pass = document.getElementById(
    "modal-user-container-content-password"
  );
  let user_province = document.getElementById(
    "modal-user-container-content-province"
  );
  let user_district = document.getElementById(
    "modal-user-container-content-district"
  );
  let user_ward = document.getElementById("modal-user-container-content-ward");
  let user_houseAndRoadAddress = document.getElementById(
    "modal-user-container-content-houseAndRoadAddress"
  );
  let user_status_true = document.getElementById(
    "modal-user-container-content-status-true"
  );
...
var resetErrUserForm = () => {
  let user_name_err = document.querySelector(
    ".modal-user-container-content-name__err"
  );
  let user_phone_err = document.querySelector(
    ".modal-user-container-content-phone__err"
  );
  let user_email_err = document.querySelector(
    ".modal-user-container-content-email__err"
  );
  let user_pass_err = document.querySelector(
    ".modal-user-container-content-password__err"
  );
  let user_province_err = document.querySelector(
    ".modal-user-container-content-province__err"
  );
  let user_district_err = document.querySelector(
    ".modal-user-container-content-district__err"
  );
  let user_ward_err = document.querySelector(
    ".modal-user-container-content-ward__err"
  );
  let user_houseAndRoadAddress_err = document.querySelector(
    ".modal-user-container-content-houseAndRoadAddress__err"
  );
...
var checkUserForm = (action) => {
  ...
  if (user_houseAndRoadAddress.value.trim() == "") {
    ...
    user_houseAndRoadAddress_err.innerText =
      "*Trường này không vượt quá 50 kí tự";
    user_houseAndRoadAddress_err.style.display = "block";
    valid = false;
  }
  ...
  if (valid) {
    let result = confirm(
      `Bạn có chắc chắn muốn ${action} người dùng này vào cơ sở dữ liệu?`
    );
    valid = result;
  }
...
var displayEditUserModal = (userId) => {
  ...
  let user_status_false = document.getElementById(
    "modal-user-container-content-status-false"
  );
...
var checkValidateAdminAccountForm = () => {
  ...
  if (valid) {
    let result = confirm(
      `Bạn có chắc chắn muốn sửa thông tin quản trị của mình trong cơ sở dữ liệu?`
    );
    valid = result;
  }
...
var displayInsertInventoryReceivingVoucherModal = (InID) => {
  //Display
  let modal_heading = document.querySelector(
    ".modal-inventory-container-content__heading"
  );
  let modal = document.querySelector(".modal-inventory");
  let btnAdd = document.querySelector(
    ".modal-inventory-container-content__btn.insert"
  );
  let btnEdit = document.querySelector(
    ".modal-inventory-container-content__btn.edit"
  );
  ...
  //Set up
  let InID_Ui = document.querySelector(
    ".modal-inventory-container-content-info__inid-re"
  );
  InID_Ui.value = InID;
  let today = new Date();
  ...
  let date_input = document.querySelector(
    ".modal-inventory-container-content-info__date-re"
  );
  date_input.value = today;
  let supplier_cb = document.querySelector(
    ".modal-inventory-container-content-info__supplier-re"
  );
  supplier_cb.value = "";
  let total_result = document.querySelector(
    ".modal-inventory-container-content__total-re"
  );
  total_result.innerText = ": 0 VND";

  //Reset table
  let tbody = document.querySelector(
    ".modal-inventory-container-content__table tbody"
  );
  tbody.innerHTML = "";
...
//Inventory receiving voucher
var displayUpdateInventoryReceivingVoucherModal = (
  InID,
  SupplierText,
  Date
) => {
    ...
    if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
      ...
      data.forEach(function (detail) {
        ...
        html += `   <td>${detail.ProductID}</td>
                    ...
                    <td>${Number(detail.ReceivingUnitPrice).toLocaleString(
                      "en-US"
                    )}</td>
                    <td><input type="number" min = "1" value="${
                      detail.Quantity
                    }" style="width: 50px; text-align: center; border: 1px solid #ccc; border-radius: 4px;" oninput = "eventChangeForInputQuantiyInventoryModel(this);" onkeydown="eventKeyDownForInputQuantiyInventoryModel(event);"></td>
                    <td>${(
                      detail.ReceivingUnitPrice * detail.Quantity
...
var deleteReceivingVoucher = (InID) => {
  if (
    confirm(
      `Bạn có chắc chắn muốn xóa phiếu nhập có mã ${InID} ra khỏi cơ sở dữ liệu?`
    )
  ) {
    //Tao doi tuong xmlrequest
    let xhr = new XMLHttpRequest();
...
var insertReceivingDetailUi = (ProductId, ProductName, ImportPrice) => {
  let receivingDetailModel = document.querySelector(
    ".modal-inventory-container-content__table tbody"
  );
  let trs = document.querySelectorAll(
    ".modal-inventory-container-content__table tbody tr"
  );
  for (let i = 0; i < trs.length; i++) {
    let tr = trs[i];
    if (tr.firstElementChild.innerText == ProductId) {
      tr.children[3].firstElementChild.value =
        Number(tr.children[3].firstElementChild.value) + 1;
      tr.children[4].innerText = (
        Number(tr.children[2].innerText.replace(/,/g, "")) *
        Number(tr.children[3].firstElementChild.value)
...
var resetSearchProductForReceivingVoucher = () => {
  ...
  let input = document.querySelector(
    ".modal-inventory-container-content__search-input"
  );
  let subnav = document.querySelector(
    ".modal-inventory-container-content__search-result"
  );
...
var updateReceivingVoucherTotal = () => {
  let total = 0;
  let total_Ui = document.querySelector(
    ".modal-inventory-container-content__total-re"
  );
  let trs = document.querySelectorAll(
    ".modal-inventory-container-content__table tbody tr"
...
var insertReceivingVoucher = () => {
  ...
  if (err != "") {
    ...
    confirm("Bạn có chắc chắn muốn thêm phiếu nhập này vào cơ sở dữ liệu?")
  ) {
    //If validate, let insert
    //Information of receiving voucher
    let reId = document.querySelector(
      ".modal-inventory-container-content-info__inid-re"
    ).value;
    let supplierId = document
      .querySelector(".modal-inventory-container-content-info__supplier-re")
      .value.split("_")[0];
    let date = document.querySelector(
      ".modal-inventory-container-content-info__date-re"
    ).value;
    let total = document
      .querySelector(".modal-inventory-container-content__total-re")
      .innerText.split(" ")[1]
      .replace(/,/g, "");
    ...
    for (let i = 0; i < trs.length; i++) {
      ...
      receivingDetailString +=
        ...
        tr.children[3].firstElementChild.value +
        "@" +
        tr.children[2].innerText.replace(/,/g, "");
      if (i < trs.length - 1) {
        receivingDetailString += "#";
      }
    }
    ...
    var data =
      ...
      "&details=" +
      encodeURIComponent(receivingDetailString);
    xhr.send(data);
  }
};
...
var updateReceivingVoucher = () => {
  ...
  if (err != "") {
    ...
    confirm("Bạn có chắc chắn muốn sửa phiếu nhập này trong cơ sở dữ liệu?")
  ) {
    //If validate, let insert
    //Information of receiving voucher
    let reId = document.querySelector(
...
var displayOrderDetailModal = (OrderID) => {
  ...
  xhr.onreadystatechange = function () {
    if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
      ...
      data.forEach(function (order) {
        let orderId_ui = document.querySelector(
          ".modal-order-container-content-info__inid-re"
        );
        let user_ui = document.querySelector(
          ".modal-order-container-content-info__user-re"
        );
        let date_ui = document.querySelector(
          ".modal-order-container-content-info__date-re"
        );
        let payment_ui = document.querySelector(
          ".modal-order-container-content-info__payment-re"
        );
        let state_ui = document.querySelector(
          ".modal-order-container-content-info__state-re"
        );
        let address_ui = document.querySelector(
          ".modal-order-container-content-info__address-re"
        );
        let total = document.querySelector(
          ".modal-order-container-content__total-re"
        );
        let fee_ship = document.querySelector(
          ".modal-order-container-content__fee-re"
        );
        let voucher = document.querySelector(
          ".modal-order-container-content__voucher-re"
        );
        let discount = document.querySelector(
          ".modal-order-container-content__discount-re"
        );
        let total_final = document.querySelector(
          ".modal-order-container-content__payment-re"
        );
        ...
        total.innerText =
          Number(order.OrderTotal).toLocaleString("en-US") + "  VND";
        fee_ship.innerText =
          Number(order.ShippingFee).toLocaleString("en-US") + "  VND";
        voucher.innerText = order.VoucherID;
        discount.innerText =
          Number(order.OrderDiscount).toLocaleString("en-US") + "    VND";
        total_final.innerText =
          (
            Number(order.OrderTotal) +
            Number(order.ShippingFee) -
            Number(order.OrderDiscount)
  ...
  xhrr.onreadystatechange = function () {
    if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
      let tbody = document.querySelector(
        ".modal-order-container-content__table tbody"
      );
      let data = JSON.parse(this.responseText);
      let html = "";
      data.forEach(function (detail) {
        ...
        html += `   <td>${detail.ProductID}</td>
                    ...
                    <td>${(detail.UnitPrice * detail.Quantity).toLocaleString(
                      "en-US"
                    )}</td>`;
        html += "</tr>";
      });
...
var displayModalStatistic = () => {
  ...
  if (
    new Date(document.querySelector(".statistic-stock__date").value) >
    ...
    let heading = document.querySelector(
      ".modal-statistic-container-content__heading"
    );
    let img = document.querySelector(
      ".modal-statistic-container-content_img > img"
    );
    let product_name = document.querySelector(
      ".modal-statistic-container-content__name"
    );
    let date = document.querySelector(
      ".modal-statistic-container-content__date-re"
    );
    let quantity = document.querySelector(
      ".modal-statistic-container-content__quantity-re"
    );
    ...
    xhr.open(
      "GET",
      `get-product-quantity.php?ProductID=${search_value_arr[1]}&Date=${date_input.value}`,
      true
    );
...
var checkDateForStatisticSearch = () => {
  let dateFrom = document.querySelector(
    ".product-sale-search__date-from"
  ).valueAsDate;
  let dateTo = document.querySelector(
    ".product-sale-search__date-to"
  ).valueAsDate;
  if (dateFrom > dateTo) {
    alert("Ngày bắt đầu phải nhỏ hơn hoặc bằng ngày kết thúc!");
    return false;
